...
parser.add_argument("--variant", help="Implementation variant", type=str.casefold,
                    choices=["numba", "numpy"], default="numba")
parser.add_argument("--threading-layer", help="Threading layer", choices=["omp", "tbb", "workqueue"], default="omp")
